...
class TipoDeMuebleDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.obj.delete()
        messages.success(self.request, "Tipo de Mueble " + str(self.obj) + " eliminado con éxito.", extra_tags=next)
        ...
        if form.is_valid():
            ...
            if 'regEdit' in request.POST:
                messages.success(self.request, "Mueble '" + str(id_reg) + "' agregado con éxito.",
                                 extra_tags=reverse('umuebles:list_mueble'))
...
class MuebleDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.obj.delete()
        messages.success(self.request, "Mueble " + str(self.obj) + " eliminado con éxito.", extra_tags=next)
        return render(request, '../../mensaje/templates/mensaje.html', {'obj': context})
        ...
        if form.is_valid():
            ...
            if 'regEdit' in request.POST:
                messages.success(self.request, "Especificación '" + str(id_reg) + "' agregado con éxito.",
                                 extra_tags=reverse('umuebles:list_especificaciondemueble'))
...
class EspecificacionDeMuebleDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.obj.delete()
        messages.success(self.request, "Especificación de Mueble " + str(self.obj) + " eliminado con éxito.", extra_tags=next)
        return render(request, '../../mensaje/templates/mensaje.html', {'obj': context})
