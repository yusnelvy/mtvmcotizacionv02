...
urlpatterns = patterns('',
                       ...
                       # url(r'^actualizarFasesProceso/$',
                       #     views.cambiar_EstadoFases,
                       #     name='actualizarFasesProceso'),
                       # url(r'^cantidadDeSeguimientos/$',
                       #     views.cantidad_Seguimientos,
                       # #     name='cantidadDeSeguimientos'),
                       # url(r'^porcentajeFasesDelProceso/$',
                       #     views.porcentaje_FasesDelProceso,
                       #     name='porcentajeFasesDelProceso'),
                       # url(r'^fasesFasesDelProceso/$',
                       #     views.fases_FasesDelProceso,
                       #     name='fasesFasesDelProceso'),
