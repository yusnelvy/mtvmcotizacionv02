    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if 'regEdit' in request.POST:
                messages.success(self.request, "Tipo de materiaal '" + str(id_reg) + "'  agregado con éxito.",
                                 extra_tags=reverse('umateriales:list_tipodematerial'))
...
class TipoDeMaterialDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.obj.delete()
        messages.success(self.request, "Tipo de material " + str(self.obj) + " eliminado con éxito.", extra_tags=next)
        ...
        if form.is_valid():
            ...
            if 'regEdit' in request.POST:
                messages.success(self.request, "Material agregado con éxito.",
                                 extra_tags=reverse('umateriales:list_material'))
                return HttpResponseRedirect(reverse('umateriales:edit_material',
                                                    args=(id_reg.id,)))
            else:
                messages.success(self.request, "Material '" + str(id_reg) + "'  agregado con éxito.")
...
class MaterialDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.obj.delete()
        messages.success(self.request, "Material eliminado con éxito.", extra_tags=next)
        return render(request, '../../mensaje/templates/mensaje.html', {'obj': context})
